...
# 50442wxapp贵工程寝室快修小程序

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=102)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款贵工程寝室快修小程序这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以贵工程寝室快修小程序是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用贵工程寝室快修小程序可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用贵工程寝室快修小程序，其意义如下：

第一点：贵工程寝室快修小程序的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对贵工程寝室快修小程序设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对贵工程寝室快修小程序进行介绍时，将按照如下内容进行。

第一部分：介绍贵工程寝室快修小程序研究的背景意义，便于用户了解系统；

第二部分：介绍开发贵工程寝室快修小程序需要搭建的环境，包括技术和工具；

第三部分：介绍用户对贵工程寝室快修小程序的功能要求，以及对贵工程寝室快修小程序的性能要求等；
...
# 第2章 开发环境与技术
贵工程寝室快修小程序的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对贵工程寝室快修小程序用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，贵工程寝室快修小程序开发可行。
### 3.1.3 操作可行性
贵工程寝室快修小程序根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作贵工程寝室快修小程序。
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学生.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学生.jpg")
学生实体属性图

（3）下图是维修人员实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\维修人员.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\维修人员.jpg")
维修人员实体属性图
...
（5）下图是维修人员评价实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\维修人员评价.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\维修人员评价.jpg")
维修人员评价实体属性图

（6）下图是在线报修实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\在线报修.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\在线报修.jpg")
在线报修实体属性图
...
|3|weixiuyuan\_id|Integer|维修人员|是|
...
|3|guzhangshangbao\_uuid\_number|String|报修编号|是|
|4|quyu\_types|Integer|区域|是|
|5|guzhangshangbao\_address|String|详细地址|是|
|6|guzhangshangbao\_guzhang|String|故障信息|是|
|7|guzhangshangbao\_types|Integer|故障类型|是|
|8|weixiuyuan\_id|Integer|维修人员|是|
|9|guzhangshangbao\_yesno\_types|Integer|处理结果|是|
|10|guzhangshangbao\_yesno\_text|String|处理回复|是|
|11|guzhangshangbao\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|weixiuyuan\_name|String|维修人员姓名|是|
|3|weixiuyuan\_phone|String|维修人员手机号|是|
|4|weixiuyuan\_id\_number|String|维修人员身份证号|是|
|5|weixiuyuan\_photo|String|维修人员头像|是|
|6|weixiuyuan\_email|String|维修人员邮箱|是|
|7|weixiuyuan\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|weixiuyuan\_id|Integer|维修人员|是|
|3|yonghu\_id|Integer|学生|是|
|4|weixiuyuan\_commentback\_pingfen\_number|Integer|评分|是|
|5|weixiuyuan\_commentback\_text|String|评价内容|是|
...
图5.1 学生信息管理页面
### 5.2 在线报修管理
如图5.2显示的就是在线报修管理页面，此页面提供给管理员的功能有：查看已发布的在线报修数据，修改在线报修，在线报修作废，即可删除，还进行了对在线报修名称的模糊查询 在线报修信息的类型查询等等一些条件。
